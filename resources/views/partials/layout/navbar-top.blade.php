<div class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand d-none d-sm-block flex-shrink-0" href="{{ route('home') }}"><img src="/storage/theme/logo-dark.png"
                width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2"
            href="index.html"><img src="/storage/theme/logo-icon.png" width="74" alt="Cartzilla">
        </a>
        ...
        <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center ms-5">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                ...
                class="navbar-tool navbar-stuck-toggler" href="#">
            ...
            <div class="account navbar-tool dropdown ms-1 ms-lg-0 me-n1 me-lg-2">
                ...
                <a href="{{ auth()->check() ? route('account.index') : route('login') }}"
                    class="navbar-tool-text dropdown-toggle ms-n3">
                    <small>
                        @auth
