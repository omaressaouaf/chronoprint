                ...
                <div class="widget pb-2 mb-4">
                    ...
                    <form class="subscription-form validate"
                        ...
                        <div class="input-group flex-nowrap"><i
                            ...
                            <button class="btn btn-primary" type="submit" name="subscribe">{{ __('Subscribe')
                                }}</button>
                        </div>
                    ...
                    <img class="d-inline-block mt-5" src="/storage/theme/cards-alt.png" width="387"
                        alt="Payment methods">
                </div>
            </div>
        </div>
            ...
            <div class="row pb-3">
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="d-flex"><i class="ci-rocket text-primary" style="font-size: 2.25rem;"></i>
                        <div class="ps-3">
                            <h6 class="fs-base text-light mb-1">{{ __('Fast and free delivery in casablanca') }}</h6>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="d-flex"><i class="ci-currency-exchange text-primary" style="font-size: 2.25rem;"></i>
                        <div class="ps-3">
                            ...
                            <p class="mb-0 fs-ms text-light opacity-50">{{ __('We return money within 30 days') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="d-flex"><i class="ci-card text-primary" style="font-size: 2.25rem;"></i>
                        <div class="ps-3">
                            <h6 class="fs-base text-light mb-1">{{ __('Secure online payment with CMI') }}</h6>
                            <p class="mb-0 fs-ms text-light opacity-50">
            ...
            <div class="row pb-2">
                <div class="col-md-6 text-center text-md-start mb-4">
                    <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3" href="#"><img
                                class="d-block" src="/storage/theme/footer-logo-light.png" width="117"
                                alt="Cartzilla"></a>
                    </div>
                </div>
