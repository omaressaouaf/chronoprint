<section class="container-fluid px-0">
    <div class="row g-0">
        <div class="col-md-3"><a class="card border-0 rounded-0 text-decoration-none py-md-4 bg-faded-primary"
                href="http://fournishop.ma/" target="_blank" rel="noopener">
                <div class="card-body text-center"><i class="ci-navigation
                    h3 mt-2 mb-4 text-primary"></i>
                    <h3 class="h5 mb-1">{{ __('Visit our other website') }}</h3>
                    <p class="text-muted fs-sm">{{ __('Check out furniture products') }}</p>
                </div>
            </a></div>
        <div class="col-md-3"><a class="card border-0 rounded-0 text-decoration-none py-md-4 bg-faded-accent"
                href="https://www.instagram.com/fournishopmaroc/" target="_blank" rel="noopener">
        ...
        <div class="col-md-3">
            <div class="card border-0 rounded-0 text-decoration-none py-md-4 bg-faded-primary">
                <div class="card-body text-center"><i class="ci-mail h3 mt-2 mb-4 text-primary"></i>
                    <h3 class="h5 mb-1">{{ __('E-Mail Address') }}</h3>
                    <p class="text-muted fs-sm">{{setting("site.email")}}
                    </p>
                </div>
            </div>
        </div>
