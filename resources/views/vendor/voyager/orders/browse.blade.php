                           ...
                           <div class="col-2">
                              <select id="filter"
                                 ...
                                 <option value="contains"
                                    @if ($search->filter == 'contains') selected @endif>contains</option>
                                 <option value="equals"
                                    ...
                                    <td>
                                       @if ($row->field === 'status')
                                          <h4>
                                             <span
                                                class="label
                                                @if (in_array($data->{$row->field}, ['pending', 'failed']))
                                                  label-danger
                                                @elseif(in_array($data->{$row->field}, ['shipped', 'delivered']))
                                                  label-success
                                                @else
                                                  label-primary
                                                @endif
                                       ...
                                       @elseif (isset($row->details->view))
                                          ...
                                          => $data->{$row->field}, 'action' => 'browse', 'view' =>
    ...
    true,
      ...
      $('td').on('click', '.delete', function(e) {
         $('#delete_form')[0].action =
            '{{ route('voyager.' . $dataType->slug . '.destroy', '__id') }}'.replace('__id',
               $(
                  this).data('id'));
