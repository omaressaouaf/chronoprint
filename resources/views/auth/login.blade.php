        ...
        <div class="col-md-7">
            <div class="card border-0 shadow">
                <div class="card-body p-5">
                    ...
                    <div class="py-3">
                        <h3 class="d-inline-block align-middle fs-base fw-medium mb-2 me-2">{{__("With a social account")}}</h3>
                        <div class="d-inline-block align-middle"><a class="btn-social bs-google me-2 mb-2" href="#"
                                data-bs-toggle="tooltip" title="Google"><i class="ci-google"></i></a><a
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group mb-3">
                            <div class="input-group">
                                ...
                                <input type="email" placeholder="Email"
                                    class="form-control rounded-start @error('email') is-invalid @enderror" name="email"
                        ...
                        <div class="form-group mb-3">
                            ...
                            @error('password')
                            <span class="invalid-feedback" style="font-size: small" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            @enderror
                        </div>
